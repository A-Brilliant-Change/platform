export const infrastructureDoctrine = {
  ...
  principles: [
    "People remain the center of design.",
    "Systems must be coordinated, not fragmented.",
    "Opportunity is made real through trust and access.",
  ],
} as const;
